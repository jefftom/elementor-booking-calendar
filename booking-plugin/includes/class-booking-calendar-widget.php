...
class BR_Booking_Calendar_Widget {
    ...
    public function enqueue_scripts() {
        if (is_singular() && has_shortcode(get_post()->post_content, 'booking_calendar')) {
            ...
            wp_localize_script('br-calendar-script', 'br_calendar', array(
                ...
                'start_day' => get_option('br_week_start_day', 'saturday'), // Saturday default for rentals
    ...
    public function ajax_get_calendar_data() {
        ...
        // Adjust to start on the configured start day (e.g., Saturday)
    ...
    public function ajax_submit_booking() {
        ...
        if (!$this->validate_booking_dates($checkin, $checkout)) {
            wp_send_json_error(array('message' => __('Invalid booking dates selected', 'booking-requests')));
        }
