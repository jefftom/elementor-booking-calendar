...
<div class="wrap">
    ...
    <form method="post" action="">
        <?php wp_nonce_field('br_settings_nonce'); ?>
                ...
                <tr>
                    ...
                    <td>
                        <select id="week_start_day" name="week_start_day">
                            ...
                            ?>
                                <option value="<?php echo $value; ?>" <?php selected($current_day, $value); ?>>
                                    <?php echo $label; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
        ...
        <div class="br-settings-section">
            ...
            <table class="form-table br-settings">
                ...
                <tr>
                    ...
                    <td>
                        <code>[booking_calendar months="12" start_day="saturday" show_form="yes"]</code>
                        <p class="description">
